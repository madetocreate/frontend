...
export function buildCommands(ctx: CommandContext): Command[] {
  ...
  const navCommands: Command[] = [
    ...
    {
      id: 'nav-growth',
      label: 'Gehe zu Wachstum',
      category: 'navigation',
      icon: MegaphoneIcon,
      action: () => dispatch(AKLOW_EVENTS.OPEN_MODULE, { module: 'new1' }),
      keywords: ['wachstum', 'growth', 'marketing', 'ads'],
    },
    {
      id: 'nav-documents',
      label: 'Gehe zu Dokumente',
      category: 'navigation',
      icon: DocumentIcon,
      action: () => dispatch(AKLOW_EVENTS.OPEN_MODULE, { module: 'new2' }),
      keywords: ['dokumente', 'documents', 'files', 'dateien', 'pdf'],
    },
    {
      id: 'nav-customers',
      label: 'Gehe zu Kunden',
      category: 'navigation',
      icon: UserGroupIcon,
      action: () => dispatch(AKLOW_EVENTS.OPEN_MODULE, { module: 'automation' }),
      keywords: ['kunden', 'customers', 'crm', 'kontakte'],
    },
    {
      id: 'nav-shield',
      label: 'Gehe zu Shield',
      category: 'navigation',
      icon: ShieldCheckIcon,
      action: () => dispatch(AKLOW_EVENTS.OPEN_MODULE, { module: 'shield' }),
      keywords: ['shield', 'sicherheit', 'security', 'protection', 'pii'],
    },
    {
      id: 'nav-phone',
