        ...
        <div className="relative isolate pt-24 sm:pt-32">
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              ...
              <div className="mt-10 flex items-center gap-x-6">
                <a
                  ...
                  className="rounded-xl bg-[var(--ak-color-primary)] px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[var(--ak-color-primary-hover)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ak-color-primary)] transition-all"
                >
                  Features entdecken
                </a>
            ...
            <div className="mt-16 sm:mt-24 lg:mt-0 lg:shrink-0 lg:grow">
               <div className="relative w-full max-w-[600px] aspect-[9/16] mx-auto rounded-[2.5rem] bg-[#1D1D1F] border-4 border-[#2D2D2F] shadow-2xl overflow-hidden">
                   {/* Mock UI for Simple App */}
                   ...
                   <div className="p-6 pt-20 space-y-4">
                      ...
                      <div className="h-32 bg-gray-800/50 rounded-2xl animate-pulse" />
          ...
          <div className="relative isolate overflow-hidden bg-[#1D1D1F] px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
              <div className="lg:row-start-2 lg:max-w-md">
                <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl ak-heading">
