/**
 * Core-10 Diagnostics API Route (Admin-Only)
 * 
...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = new URL(`${AGENT_BACKEND_URL}/api/v1/internal/admin/diagnostics/core10`)
    if (finalTenantId) {
    ...
    console.error('Core-10 diagnostics error:', error)
    return NextResponse.json(
