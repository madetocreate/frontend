/**
 * Onboarding Progress API Route (Server-Only)
 * 
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(`${AGENT_BACKEND_URL}/api/v1/onboarding/get_progress`, {
      method: 'POST',
      headers: {
    ...
    console.error('Onboarding get_progress error:', error)
    return NextResponse.json(
