/**
 * Onboarding Profile Snapshot API Route (Server-Only)
 * 
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(`${AGENT_BACKEND_URL}/api/v1/onboarding/profile_snapshot`, {
      method: 'POST',
      headers: {
    ...
    console.error('Onboarding profile_snapshot error:', error)
    return NextResponse.json(
