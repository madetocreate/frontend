    ...
    <div className="p-6 space-y-6">
      ...
      >
        <SettingsSelect
          ...
          leading={<PhoneIcon className="h-5 w-5 text-blue-500" />}
          value={modeType}
          options={[
            { value: 'support', label: 'Support & Anfragen' },
            { value: 'reservation', label: 'Reservierungen' },
        ...
        {mode === 'expert' && (
          <>
            ...
            <SettingsRow
              ...
              leading={<MicrophoneIcon className="h-5 w-5" />}
              trailing={<span className="text-sm text-gray-600">gpt-4o-mini-transcribe</span>}
              mode={mode}
            />
          </>
        )}
      ...
      {mode === 'expert' && (
        ...
        >
          <SettingsRow
            ...
            trailing={<span className="text-sm text-gray-400 font-mono">wss://api.openai.com/v1/realtime</span>}
            mode={mode}
          />
          <SettingsRow
            ...
            leading={<ClockIcon className="h-5 w-5" />}
            trailing={<span className="text-sm text-gray-600">300s</span>}
            mode={mode}
          />
        </SettingsSection>
      )}
