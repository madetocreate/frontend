...
const AVAILABLE_WIDGETS: Record<WidgetType, { title: string; description: string; icon: typeof Squares2X2Icon }> = {
  'overview-stats': { 
    ...
    description: 'Immobilien, Leads, Besichtigungen',
    icon: BuildingOfficeIcon
  },
  'properties-list': { 
    title: 'Immobilien-Liste', 
    description: 'Liste aller Immobilien',
    icon: BuildingOfficeIcon
  },
  'leads-list': { 
    title: 'Leads', 
    description: 'Aktive Leads',
    icon: UserGroupIcon
  },
  'calendar-viewings': { 
    title: 'Besichtigungen', 
    description: 'Kommende Besichtigungen',
    icon: CalendarIcon
  },
  'documents-list': { 
    title: 'Dokumente', 
    description: 'Exposés und Verträge',
    icon: DocumentTextIcon
  },
  'market-analysis': { 
    title: 'Marktanalyse', 
    description: 'Markt-Trends und Preise',
    icon: MagnifyingGlassIcon
  },
}

export function RealEstateDashboardConfigurator() {
  const [layouts, setLayouts] = useState<DashboardLayout[]>([
    {
      ...
      widgets: [
        ...
        { id: '2', type: 'properties-list', title: 'Immobilien', size: 'medium', position: { x: 0, y: 1 }, enabled: true },
        { id: '3', type: 'leads-list', title: 'Leads', size: 'medium', position: { x: 1, y: 1 }, enabled: true },
      ]
    }
  ])
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Passen Sie Ihr Immobilien-Dashboard nach Ihren Bedürfnissen an</p>
        </div>
