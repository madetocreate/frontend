...
const STATUS_COLORS = {
  ...
  Abgebrochen: 'bg-red-100 text-red-700 border-red-200',
  Weitergeleitet: 'bg-blue-100 text-blue-700 border-blue-200',
} as const
