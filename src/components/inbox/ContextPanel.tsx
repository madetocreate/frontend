...
export const ContextPanel: React.FC<ContextPanelProps> = ({ item }) => {
  const getChannelIcon = () => {
    switch (item.channel) {
      ...
      case 'chat': return <ChatBubbleLeftEllipsisIcon className="w-3.5 h-3.5 mr-1" />;
      ...
      <DrawerCard title="Kontakt">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[var(--ak-color-bg-surface-muted)] to-[var(--ak-color-bg-hover)] flex items-center justify-center border border-white shadow-sm">
