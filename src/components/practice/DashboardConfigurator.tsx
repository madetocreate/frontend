...
const AVAILABLE_WIDGETS: Record<WidgetType, { title: string; description: string; icon: typeof Squares2X2Icon }> = {
  'overview-stats': { 
    ...
    description: 'Patienten, Termine, Dokumente',
    icon: UserGroupIcon
  },
  'patients-list': { 
    title: 'Patienten-Liste', 
    description: 'Liste aller Patienten',
    icon: UserGroupIcon
  },
  'appointments-calendar': { 
  ...
  'documents-list': { 
    title: 'Dokumente', 
    description: 'Offene Dokumente',
    icon: DocumentTextIcon
  },
  'statistics-chart': { 
    title: 'Statistiken', 
    description: 'Praxis-Statistiken',
    icon: ChartBarIcon
  },
  'phone-reception': { 
    title: 'Telefon-Rezeption', 
    description: 'Anrufe und Nachrichten',
    icon: PhoneIcon
  },
  'forms-list': { 
    title: 'Formulare', 
    description: 'Verfügbare Formulare',
    icon: ClipboardDocumentListIcon
  },
  'billing-summary': { 
    title: 'Abrechnung', 
    description: 'Abrechnungs-Übersicht',
    icon: CreditCardIcon
  },
  'compliance-status': { 
    title: 'Compliance', 
...
export function PracticeDashboardConfigurator() {
  const [layouts, setLayouts] = useState<DashboardLayout[]>([
    {
      ...
      widgets: [
        ...
        { id: '2', type: 'patients-list', title: 'Patienten', size: 'medium', position: { x: 0, y: 1 }, enabled: true },
        { id: '3', type: 'appointments-calendar', title: 'Termine', size: 'medium', position: { x: 1, y: 1 }, enabled: true },
      ]
    }
  ])
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Passen Sie Ihr Praxis-Dashboard nach Ihren Bedürfnissen an</p>
        </div>
      ...
      <div className="bg-white/80 backdrop-blur-xl rounded-xl border border-gray-100 shadow-sm p-4">
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition-all duration-200"
          >
            {layouts.map(layout => (
