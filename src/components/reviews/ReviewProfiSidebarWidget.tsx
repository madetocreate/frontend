...
const VIEWS: { id: ReviewProfiView; label: string; icon: typeof Squares2X2Icon; category: string; shortcut?: string }[] = [
  { id: 'overview', label: 'Übersicht', icon: Squares2X2Icon, category: 'Haupt', shortcut: '⌘1' },
  { id: 'reviews', label: 'Bewertungen', icon: StarIcon, category: 'Haupt', shortcut: '⌘2' },
  { id: 'analytics', label: 'Analytics', icon: ChartBarIcon, category: 'Business', shortcut: '⌘3' },
  { id: 'integrations', label: 'Integrationen', icon: PuzzlePieceIcon, category: 'System', shortcut: '⌘4' },
