...
import { DrawerCard, DrawerSectionTitle, ActionGroup, ActionButton } from '@/components/ui/drawer-kit'
...
export function SettingsInspectorDrawerV2({ view, mode = 'simple', onClose, onExpand, isExpanded }: SettingsInspectorDrawerProps) {
    ...
    <AkDrawerScaffold
      header={
        <InspectorHeader
          ...
          actions={
             <AkBadge tone="neutral" size="xs">Lokal</AkBadge>
          }
        />
      }
      title={null}
      ...
      <div className="flex flex-col h-full">
          ...
          <div className="p-6 space-y-6">
            ...
            {mode === 'expert' && metadata.dangerZone && (
              <DrawerCard className="border-[var(--ak-color-border-danger)]/30 bg-[var(--ak-color-bg-danger)]/5">
                <DrawerSectionTitle className="text-[var(--ak-color-text-danger)]">Gefahrenzone</DrawerSectionTitle>
                <div className="flex items-start gap-3">
                  <ShieldExclamationIcon className="h-5 w-5 text-[var(--ak-color-text-danger)] shrink-0" />
                  <div className="space-y-3">
                    <p className="text-xs text-[var(--ak-color-text-danger)] leading-relaxed font-medium">
                      {metadata.dangerZone}
                    </p>
                    <ActionButton 
        ...
        {activeTab === 'ki' && (
          <div className="p-4 flex-1 overflow-y-auto ak-scrollbar">
            <AISuggestionGrid
                context="settings"
                summary={`Einstellungen: ${metadata.title}`}
