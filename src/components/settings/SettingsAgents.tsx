    ...
    <div className="p-6 space-y-6">
      ...
      >
        <SettingsRow
          ...
          leading={<ServerIcon className="h-5 w-5 text-green-500" />}
          trailing={
        ...
        {mcpEnabled && (
          <>
            <SettingsInput
              ...
              leading={<ServerIcon className="h-5 w-5 text-blue-500" />}
              value={mcpUrl}
              onChange={setMcpUrl}
              mode={mode}
            />
        ...
        <>
          ...
          >
            <SettingsRow
              ...
              leading={<CheckCircleIcon className="h-5 w-5 text-green-500" />}
              trailing={<span className="text-sm text-green-600 font-medium">Verfügbar</span>}
              mode={mode}
            />
            <SettingsRow
