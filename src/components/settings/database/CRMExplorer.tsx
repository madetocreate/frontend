    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button className="flex items-center gap-2 px-3 py-2 rounded-lg border border-[var(--ak-color-border-subtle)] bg-[var(--ak-color-bg-surface)] text-sm font-medium hover:bg-[var(--ak-color-bg-hover)] transition-colors text-red-600 hover:bg-red-50 hover:border-red-200">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-xl border border-[var(--ak-color-border-subtle)] bg-[var(--ak-color-bg-surface-muted)]/50">
          <div className="flex items-center gap-2 text-[var(--ak-color-text-secondary)] text-xs font-medium uppercase tracking-wider mb-1">
            <ExclamationTriangleIcon className="h-4 w-4 text-orange-500" /> Duplicates
          </div>
                ...
                <td className="px-4 py-3">
                  <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                    ${customer.status === 'Active' ? 'bg-green-50 text-green-700' : 
                      customer.status === 'Inactive' ? 'bg-gray-100 text-gray-600' : 'bg-blue-50 text-blue-700'}`}>
                    {customer.status}
                  </span>
                </td>
