                    ...
                    {filteredLogs.map((log) => (
                        <tr key={log.id} className="hover:bg-[var(--ak-color-bg-hover)] transition-colors">
                            <td className="px-4 py-3">
                                {log.action === 'allowed' && <span className="flex items-center gap-1.5 text-green-600"><CheckCircleIcon className="h-4 w-4" /> <span className="text-xs font-medium">Allow</span></span>}
                                {log.action === 'blocked' && <span className="flex items-center gap-1.5 text-red-600"><XCircleIcon className="h-4 w-4" /> <span className="text-xs font-medium">Block</span></span>}
                                {log.action === 'flagged' && <span className="flex items-center gap-1.5 text-orange-500"><ExclamationTriangleIcon className="h-4 w-4" /> <span className="text-xs font-medium">Flag</span></span>}
                            </td>
                            ...
                            <td className="px-4 py-3">
                                <span className={log.action === 'blocked' ? 'text-red-600 font-medium' : 'text-[var(--ak-color-text-primary)]'}>
                                    {log.trigger}
                                </span>
                            </td>
